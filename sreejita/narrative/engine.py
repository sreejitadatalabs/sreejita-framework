...
def build_narrative(
    ...
    if domain == "healthcare":
        ...
        # GAP 1 FIX: Use the explicit interpretation generated by healthcare.py
        interpretation = kpis.get("board_confidence_interpretation", "")
        if interpretation:
            summary.append(f"GOVERNANCE ALERT: {interpretation}")
        elif kpis.get("board_confidence_score", 50) < 50:
             summary.append("GOVERNANCE ALERT: Score indicates critical operational risk requiring immediate executive intervention.")
